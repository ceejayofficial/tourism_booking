<section class="bg-white py-16 md:py-20 px-5 sm:px-6">
    ...
    <!-- CONTENT GRID -->
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-10 items-center">

        <!-- LEFT ITEMS -->
        <div class="space-y-12 md:space-y-10 text-center md:text-right">

            <!-- ITEM 1 -->
            <div>
                <div class="w-12 h-12 mx-auto md:ml-auto rounded-full border border-gray-300 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3 7h18M5 7v14a2 2 0 002 2h10a2 2 0 002-2V7M8 11h8"/>
                    </svg>
                </div>
            ...
            <div>
                <div class="w-12 h-12 mx-auto md:ml-auto rounded-full border border-gray-300 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                        d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m13-4a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
                </div>
        ...
        <!-- RIGHT ITEMS -->
        <div class="space-y-12 md:space-y-10 text-center md:text-left">

            <!-- ITEM 3 -->
            <div>
                <div class="w-12 h-12 mx-auto md:mr-auto rounded-full border border-gray-300 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <div class="w-12 h-12 mx-auto md:mr-auto rounded-full border border-gray-300 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 6 4 4 6.5 4c1.74 0 3.41 1.01 4.22 2.44C11.09 5.01 12.76 4 14.5 4 17 4 19 6 19 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                    </svg>
                </div>
