<footer class="bg-[#070b14] text-white pt-20 pb-8 px-6">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-5 gap-10">
            ...
            <div class="md:col-span-1">
                ...
                <div class="flex gap-3 mt-5">
                    ...
                    <a href="#" class="w-8 h-8 border border-gray-600 rounded-full flex items-center justify-center hover:border-white transition">
        ...
        <!-- LINE -->
        <div class="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between text-xs text-gray-500">
